...
<head>
    ...
    <title>@yield('title') Secure app </title>
...
<body>
    ...
    <nav class="flex py-5 bg-gradient-to-r from-white to-purple-300  text-base font-sans font-bold">
        <div class="w-1/2 px-12 mr-auto">
            <p class="text-2xl text-violet-800 font-bold">My App</p>
        </div>
        <ul class="w-1/2 px-16 ml-auto flex justify-end pt-1 text-white">
            ...
            <li>
                <a href="" class="font-semibold bg-violet-700 hover:bg-violet-900 py-3 px-4 rounded-lg">Register</a>
            </li>
        </ul>
    </nav>
