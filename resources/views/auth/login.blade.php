...
<div>
    <div class="grid gap-4 mx-auto text-center bg-gradient-to-r via-violet-100 from-violet-300 to-violet-300 my-24 px-9 py-10 font-sans place-content-center max-h-fit  rounded-3xl w-1/3">

        <form action="{{route('login-user')}}" method="POST" class="mt-4 bg-transparent text-base ">
